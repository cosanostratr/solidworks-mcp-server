...
/**
 * Limits for preventing infinite loops and resource exhaustion
 */
export const PerformanceLimits = {
  /** Maximum iterations for feature traversal loops */
  MAX_FEATURE_ITERATIONS: 1000,

  /** Maximum selection attempts before giving up */
  MAX_SELECTION_ATTEMPTS: 50,

  /** Maximum response timings to keep in metrics (prevents memory leak) */
  MAX_RESPONSE_TIMINGS: 1000,

  /** Maximum sketch features to search for */
  MAX_SKETCH_FEATURES: 100,

  /** Maximum dimension iterations */
  MAX_DIMENSION_ITERATIONS: 500,
} as const;
